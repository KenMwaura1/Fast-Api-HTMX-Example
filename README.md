...
1. Clone this Repo
   ...
   `git clone (https://github.com/KenMwaura1/Fast-Api-HTMX-Example)`
2. Cd into the Fast-Api-HTMX-Example folder

   `cd Fast-Api-HTMX-Example`
...
Run them using `pytest .` while in the root directory (/Fast-Api-HTMX-Example)
